...
# ==============================================================================
# TODO-/Checkliste für manage_firewall.sh (Stand: 2025-06-04)
# ==============================================================================
...
# [ ] Modularer Aufbau: Einzelne Funktionen für enable, disable, allow, deny, status
...
# [ ] Unterstützung für verschiedene Firewall-Lösungen (z.B. ufw, iptables, firewalld)
