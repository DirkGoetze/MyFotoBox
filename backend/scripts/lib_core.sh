...
# DEFAULT_DIR_CONF_SSL="$DEFAULT_DIR_CONF/ssl"
# DEFAULT_DIR_CONF_SSL_CERTS="$DEFAULT_DIR_CONF_SSL/certs"
# DEFAULT_DIR_CONF_SSL_KEYS="$DEFAULT_DIR_CONF_SSL/keys"
# DEFAULT_DIR_CONF_SYSTEMD="$DEFAULT_DIR_CONF/systemd"
...
# DEFAULT_DIR_FRONTEND_PHOTOS_THUMBNAILS="$DEFAULT_DIR_FRONTEND_PHOTOS/gallery"
...
# FALLBACK_DIR_CONF_SSL="$FALLBACK_DIR_CONF/ssl"
# FALLBACK_DIR_CONF_SSL_CERTS="$FALLBACK_DIR_CONF_SSL/certs"
# FALLBACK_DIR_CONF_SSL_KEYS="$FALLBACK_DIR_CONF_SSL/keys"
# FALLBACK_DIR_CONF_SYSTEMD="$FALLBACK_DIR_CONF/systemd"
...
# FALLBACK_DIR_FRONTEND_PHOTOS_THUMBNAILS="$FALLBACK_DIR_FRONTEND_PHOTOS/gallery"
...
#: "${FRONTEND_DIR_CSS:=$DEFAULT_DIR_FRONTEND_CSS}"
#: "${FRONTEND_DIR_FONTS:=$DEFAULT_DIR_FRONTEND_FONTS}"
#: "${FRONTEND_DIR_JS:=$DEFAULT_DIR_FRONTEND_JS}"
#: "${FRONTEND_DIR_PHOTOS:=$DEFAULT_DIR_FRONTEND_PHOTOS}"
#: "${FRONTEND_DIR_PHOTOS_ORIGINAL:=$DEFAULT_DIR_FRONTEND_PHOTOS_ORIGINAL}"
#: "${FRONTEND_DIR_PHOTOS_THUMBNAILS:=$DEFAULT_DIR_FRONTEND_PHOTOS_THUMBNAILS}"
#: "${FRONTEND_DIR_PICTURE:=$DEFAULT_DIR_FRONTEND_PICTURE}"
