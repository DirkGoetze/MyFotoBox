...
DEFAULT_NGINX_CONF_DIR="$DEFAULT_CONF_DIR/nginx"
DEFAULT_NGINX_BACKUP_DIR="$DEFAULT_NGINX_CONF_DIR/backup"
...
FALLBACK_NGINX_CONF_DIR="$FALLBACK_CONF_DIR/nginx"
FALLBACK_NGINX_BACKUP_DIR="$FALLBACK_NGINX_CONF_DIR/backup"
