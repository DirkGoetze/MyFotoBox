...
main() {
    case "$1" in
        ...
        backup)
            ...
            ;;
        rollback)
            log "Starte NGINX-Rollback (webserver_manage.sh)"
        ...
        *)
            ...
            log "Fehler: Falsche Skriptverwendung (webserver_manage.sh)"
            exit 1
            ;;
    esac
}
