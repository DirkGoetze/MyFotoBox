...
debug "INFO: VENV_DIR: ${VENV_DIR:-nicht gesetzt}"
...
debug "INFO: PHOTOS_ORIGINALS_DIR: ${PHOTOS_ORIGINALS_DIR:-nicht gesetzt}"
...
debug "INFO: PHOTOS_GALLERY_DIR: ${PHOTOS_GALLERY_DIR:-nicht gesetzt}"
# Test: get_photos_originals_dir
echo "+-----------------------------------------------------------------------+"
...
debug "INFO: FRONTEND_PICTURE_DIR: ${FRONTEND_PICTURE_DIR:-nicht gesetzt}"
# Test: get_log_dir
echo "+-----------------------------------------------------------------------+"
