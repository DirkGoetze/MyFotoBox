...
echo "+-----------------------------------------------------------------------+"
test_function "manage_files_sh" "get_template_file" "ssl_cert" "cert-fotobox"
echo "+-----------------------------------------------------------------------+"
echo "| Test: get_template_file (SSL Schlüssel)                               |"
echo "+-----------------------------------------------------------------------+"
test_function "manage_files_sh" "get_template_file" "ssl_key" "key-fotobox"
echo "+-----------------------------------------------------------------------+"
echo "| Test: get_template_file (Backup-Meta-File)                            |"
echo "+-----------------------------------------------------------------------+"
test_function "manage_files_sh" "get_template_file" "backup_meta" "backup-meta-fotobox"
echo "+-----------------------------------------------------------------------+"
echo "| Test: get_template_file (Firewall)                                    |"
echo "+-----------------------------------------------------------------------+"
test_function "manage_files_sh" "get_template_file" "firewall" "firewall-fotobox"
echo "+-----------------------------------------------------------------------+"
echo "| Test: get_template_file (SSH File)                                    |"
echo "+-----------------------------------------------------------------------+"
test_function "manage_files_sh" "get_template_file" "ssh" "ssh-fotobox"
echo "+-----------------------------------------------------------------------+"
echo "| Test: get_template_file (html Datei)                                  |"
echo "+-----------------------------------------------------------------------+"
test_function "manage_files_sh" "get_template_file" "html" "html-fotobox"
echo "+-----------------------------------------------------------------------+"
echo "| Test: get_template_file (js Datei)                                    |"
echo "+-----------------------------------------------------------------------+"
test_function "manage_files_sh" "get_template_file" "js" "js-fotobox"
echo "+-----------------------------------------------------------------------+"
echo "| Test: get_template_file (css Datei)                                   |"
echo "+-----------------------------------------------------------------------+"
test_function "manage_files_sh" "get_template_file" "css" "css-fotobox"
echo "+-----------------------------------------------------------------------+"
echo "| Test: get_template_file (Allgemein)                                   |"
echo "+-----------------------------------------------------------------------+"
test_function "manage_files_sh" "get_template_file" "allgemein" "allgemein-fotobox"
